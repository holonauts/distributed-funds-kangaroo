...
const APP_NAME: &str = "Distributed Funds"; // name of the app. Can be changed without breaking your app.
const APP_ID: &str = "distributed-funds"; // App id used to install your app in the Holochain conductor - can be the same as APP_NAME. Changing this means a breaking change to your app.
pub const WINDOW_TITLE: &str = "Distributed Funds"; // Title of the window
...
pub const DEFAULT_NETWORK_SEED: Option<&str> = Some("demo-2024-03-01");  // replace-me (optional): Depending on your application, you may want to put a network seed here or
...
pub async fn launch(
    ...
    let command = Command::new_sidecar("holochain-v0.2.6")
